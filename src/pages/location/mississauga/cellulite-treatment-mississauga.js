...
export const query = graphql`
  {
    wpgraphql {
      page(id: "location/mississauga/cellulite-treatment-mississauga", idType: URI) {
        id
        title
        slug
        seo {
...
const CelluliteTreatmentMississauga = ({ data, location }) => {
...
export default CelluliteTreatmentMississauga
